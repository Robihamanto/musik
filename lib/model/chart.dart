...
class Chart {
  ...
  Chart({required this.albumChart, required this.songChart});
}
...
class AlbumChart {
  ...
  AlbumChart({required this.chart, required this.href, required this.name, required this.albums});
...
class SongChart {
  ...
  SongChart({required this.chart, required this.href, required this.name, required this.songs});
